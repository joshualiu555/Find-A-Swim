...
export const EditWorkout = () => {
    ...
    useEffect(() => {
        const fetchWorkout = async () => {
            try {
                const response = await axios.get(`https://find-a-swim-1b209de32774.herokuapp.com/workouts/edit/${workoutID}`, {
    ...
    const handleEdit = async (e) => {
        e.preventDefault()
        await axios.put(`https://find-a-swim-1b209de32774.herokuapp.com/workouts/${workoutID}`, {name, description, stroke, distance}, {
            headers: {authorization: cookies.access_token}
        })
